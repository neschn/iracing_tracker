...
from .constants import (
    LIGHT_WINDOW_BORDER_COLOR, LIGHT_BG_MAIN, LIGHT_TEXT, LIGHT_BG_SECONDARY,
    ...
    LIGHT_TITLE_BTN_CLOSE_HOVER, LIGHT_TITLE_BTN_CLOSE_PRESSED,

    DARK_WINDOW_BORDER_COLOR, DARK_BG_MAIN, DARK_TEXT, DARK_BG_SECONDARY,
    ...
    DARK_TITLE_BTN_CLOSE_HOVER, DARK_TITLE_BTN_CLOSE_PRESSED,
)
