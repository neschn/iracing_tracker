...
# Paramètres visuels et ressources
...
DELETE_ICON_PATH = os.path.join(ASSETS_DIR, "delete.svg")
...
# Bannière - Animation
BANNER_BLINK_COUNT = 5
BANNER_BLINK_DURATION_MS = 400
BANNER_FADE_DURATION_MS = 2000
